...
export default function Dashboard() {
  ...
  const updateSessions = async () => {
    ...
    const req = await api.post("/sessions/set-study-sessions", {
      sessionTimings: sessions,
    });
    const res = await req.data;
    ...
    <div>
      ...
      <div className="flex justify-center items-center">
        ...
        <input
          ...
          className="mx-5 input input-bordered w-full max-w-xs"
        />
      ...
      {sessions.length == 0 ? (
        <p className="my-10 text-center text-3xl">
          Sessions to add will show here
        </p>
      ) : null}
